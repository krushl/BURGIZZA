        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row d-flex justify-content-center align-items-center p-3">
                    <div class="admin-title col-md-3 d-flex flex-column m-5  justify-content-center align-items-center">
                    ...
                    <div class="admin-title col-md-3 d-flex flex-column m-5  justify-content-center align-items-center">
                        <a style="color:#111;" href="{{ route('admin.orders.index') }}"><div class="admin-button articles-button">Заказы</div> </a><br>
                    </div>
                </div>
            </div>
        </div>
