...
<div class="container-fluid bg-light">
    <div class="row p-3">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" action="{{ route('admin.articles.add') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="articleTitle">
                                 Название новости
                            </label>
                            <input type="text" name="articleTitle" value="{{ old('articleTitle') }}" class="form-control" id="articleTitle" />
                        </div>
                        <div class="form-group">
