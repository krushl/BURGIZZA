...
<table class="table table-responsive">
    ...
    @forelse($burgers as $burger)
        <tr>
            ...
            <td>{{$burger->price}} ₽</td>
            <td>
                <a class="btn btn-primary edit"  href = "{{route('admin.burger.burger-editForm',['burgerId'=>$burger->id])}}">&#9998;</a>
                <button class="btn btn-danger delete" data-name="{{$burger->name}}" data-burgerId="{{ $burger->id }}">
                    &#128465;
                </button>
            </td>
        </tr>
